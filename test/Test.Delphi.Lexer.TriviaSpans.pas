...
type
  ...
  private
    FLexer: TDelphiLexer;
    function Lex(const S: string): TTokenList;
    ...
    procedure AssertOwnershipInvariant(Tokens: TTokenList);
  public
...
function TTriviaSpanTests.Lex(const S: string): TTokenList;
begin
  Result := FLexer.Tokenize(S);
end;


procedure TTriviaSpanTests.AssertOwnershipInvariant(Tokens: TTokenList);
