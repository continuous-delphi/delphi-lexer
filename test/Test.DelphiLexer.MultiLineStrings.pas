unit Test.DelphiLexer.MultiLineStrings;
...
type
  ...
  private
    ...
    function RoundTrip(T: TList<TToken>): string;
    function CountStrings(T: TList<TToken>): Integer;
    function FirstString(T: TList<TToken>): TToken;
  public
    [Setup]
    procedure Setup;
    [TearDown]
...
function TMultiLineStringTests.Tok(const S: string): TList<TToken>;
begin
  Result := FLexer.Tokenize(S);
end;


function TMultiLineStringTests.RoundTrip(T: TList<TToken>): string;
var
  I: Integer;
begin
  Result := '';
...
function TMultiLineStringTests.CountStrings(T: TList<TToken>): Integer;
var
  I: Integer;
begin
  Result := 0;
...
function TMultiLineStringTests.FirstString(T: TList<TToken>): TToken;
var
  I: Integer;
begin
  for I := 0 to T.Count - 1 do
