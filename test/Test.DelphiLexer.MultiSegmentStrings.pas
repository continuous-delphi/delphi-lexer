unit Test.DelphiLexer.MultiSegmentStrings;
...
type
  ...
  private
    FLexer: TDelphiLexer;
    function Reconstruct(const T: TList<TToken>): string;
    procedure CollectStrings(const T: TList<TToken>; out Strings: TArray<string>);
  public
    [Setup]
    procedure Setup;
    [TearDown]
...
function TMultiSegmentStringTests.Reconstruct(const T: TList<TToken>): string;
var
  I: Integer;
begin
  Result := '';
...
procedure TMultiSegmentStringTests.CollectStrings(const T: TList<TToken>;
