unit Test.Delphi.Lexer.TokenCompare.Myers;
...
type
  ...
  private
    ...
    // Build a TTokenList from an open array. Caller owns the result.
    function L(const Toks: array of TToken): TTokenList;
...
function TMeyersDiffTests.L(const Toks: array of TToken): TTokenList;
var
  I: Integer;
begin
...
function TMeyersDiffTests.Diff(A, B: TTokenList;
