unit Delphi.Lexer.TokenStats.Main;
...
type
  ...
  public
    ...
    procedure Reset;
    procedure Accumulate(const AFileName: string; const ATokens: TTokenList; const AFileContents: string; const CollectInvalidTokens: Boolean);
...
procedure TTokenSummary.Accumulate(const AFileName: string; const ATokens: TTokenList; const AFileContents: string; const CollectInvalidTokens: Boolean);
var
  Tok: TToken;
  I: Integer;
  Lower: string;
